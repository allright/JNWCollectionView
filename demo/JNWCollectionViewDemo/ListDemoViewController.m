...
- (void)loadView {
	...
	[self.collectionView registerClass:ListHeader.class forSupplementaryViewOfKind:JNWCollectionViewLinearLayoutHeaderKind withReuseIdentifier:headerIdentifier];
